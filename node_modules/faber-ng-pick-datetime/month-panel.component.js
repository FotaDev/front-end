...
var MonthPanelComponent = (function () {
    function MonthPanelComponent(service) {
    ...
    MonthPanelComponent.prototype.ngOnChanges = function (changes) {
        if (changes['dialogType']) {
            this.type = changes['dialogType'].currentValue;
        }
    };
    MonthPanelComponent.prototype.ngOnInit = function () {
        this.type = 2;
    ...
    MonthPanelComponent.prototype.prevMonth = function () {
        this.moment = this.moment.clone().subtract(1, 'M');
        this.generateCalendar();
    };
    MonthPanelComponent.prototype.nextMonth = function () {
        this.moment = this.moment.clone().add(1, 'M');
        this.generateCalendar();
    };
    MonthPanelComponent.prototype.selectMonth = function (month) {
        this.moment = this.moment.clone().month(month);
        return;
    };
    MonthPanelComponent.prototype.selectYear = function (year) {
        this.moment = this.moment.clone().year(year);
        return;
    };
    MonthPanelComponent.prototype.toggleDialogType = function (type) {
    ...
    MonthPanelComponent.prototype.generateYearList = function (param) {
        var start;
        if (param === 'prev') {
    ...
    MonthPanelComponent.prototype.select = function (moment) {
    };
    MonthPanelComponent.prototype.selectToday = function () {
        this.select(this.now);
    };
    MonthPanelComponent.prototype.cancelDialog = function () {
        this.onCancelDialog.emit(true);
        return;
    };
    MonthPanelComponent.prototype.confirm = function () {
        this.onSelected.emit(this.moment);
        this.onCancelDialog.emit(true);
        return;
    };
    MonthPanelComponent.prototype.generateCalendar = function () {
        this.calendarDays = [];
