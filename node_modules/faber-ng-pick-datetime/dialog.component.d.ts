...
export declare class DialogComponent implements OnInit, OnDestroy {
    ...
    pickerType: 'both' | 'date' | 'month' | 'time';
    private subId;
    private momentFunc;
    ...
    setDialog(instance: any, elementRef: ElementRef, initialValue: any, dtLocale: string, dtViewFormat: string, dtReturnObject: string, dtPosition: 'top' | 'right' | 'bottom' | 'left', dtPositionOffset: string, dtMode: 'popup' | 'dropdown' | 'inline', dtHourTime: '12' | '24', dtTheme: string, dtPickerType: 'both' | 'date' | 'month' | 'time', dtShowSeconds: boolean, dtOnlyCurrent: boolean): void;
    confirm(close: boolean): void;
    toggleDialogType(type: DialogType): void;
    toggleMonthDialogType(type: DialogType): void;
