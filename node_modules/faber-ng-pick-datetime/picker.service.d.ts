...
export declare class PickerService {
    ...
    dtPickerType: 'both' | 'date' | 'month' | 'time';
    private _dtPosition;
    ...
    private momentFunc;
    constructor();
    setPickerOptions(dtLocale: string, dtViewFormat: string, dtReturnObject: string, dtPosition: 'top' | 'right' | 'bottom' | 'left', dtPositionOffset: string, dtMode: 'popup' | 'dropdown' | 'inline', dtHourTime: '12' | '24', dtTheme: string, dtPickerType: 'both' | 'date' | 'month' | 'time', dtShowSeconds: boolean, dtOnlyCurrent: boolean): void;
