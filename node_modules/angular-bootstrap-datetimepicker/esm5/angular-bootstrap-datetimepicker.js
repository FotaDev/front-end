...
import { ChangeDetectionStrategy, Component, ElementRef, EventEmitter, Input, NgZone, Output, NgModule } from '@angular/core';
...
var DlYearModelProvider = /** @class */ (function () {
    ...
    DlYearModelProvider.getStartOfDecade = function (fromMilliseconds) {
        var startDecade = (Math.trunc(moment$1(fromMilliseconds).year() / 10) * 10);
        return moment$1({ year: startDecade }).startOf('year');
    };
    ...
    DlYearModelProvider.prototype.getModel = function (milliseconds, selectedMilliseconds) {
        ...
        var startYear = moment$1(milliseconds).startOf('year');
        ...
        var selectedValue = selectedMilliseconds === null || selectedMilliseconds === undefined
            ...
            : moment$1(selectedMilliseconds).startOf('year').valueOf();
        var result = {
            viewName: 'year',
            viewLabel: pastYear + "-" + futureYear,
            activeDate: activeValue,
            leftButton: {
                value: moment$1(startDate).subtract(10, 'years').valueOf(),
                ariaLabel: "Go to " + (pastYear - 10) + "-" + (pastYear - 1),
                classes: {},
            },
            rightButton: {
                value: moment$1(startDate).add(10, 'years').valueOf(),
        ...
        function rowOfYears(rowNumber) {
            var currentMoment = moment$1();
            var cells = columnNumbers.map(function (columnNumber) {
                var yearMoment = moment$1(startDate).add((rowNumber * columnNumbers.length) + columnNumber, 'years');
                return {
    ...
    DlYearModelProvider.prototype.goDown = function (fromMilliseconds, selectedMilliseconds) {
        return this.getModel(moment$1(fromMilliseconds).add(5, 'year').valueOf(), selectedMilliseconds);
    };
    DlYearModelProvider.prototype.goUp = function (fromMilliseconds, selectedMilliseconds) {
        return this.getModel(moment$1(fromMilliseconds).subtract(5, 'year').valueOf(), selectedMilliseconds);
    };
    DlYearModelProvider.prototype.goLeft = function (fromMilliseconds, selectedMilliseconds) {
        return this.getModel(moment$1(fromMilliseconds).subtract(1, 'year').valueOf(), selectedMilliseconds);
    };
    DlYearModelProvider.prototype.goRight = function (fromMilliseconds, selectedMilliseconds) {
        return this.getModel(moment$1(fromMilliseconds).add(1, 'year').valueOf(), selectedMilliseconds);
    };
    DlYearModelProvider.prototype.pageDown = function (fromMilliseconds, selectedMilliseconds) {
        return this.getModel(moment$1(fromMilliseconds).add(10, 'year').valueOf(), selectedMilliseconds);
    };
    DlYearModelProvider.prototype.pageUp = function (fromMilliseconds, selectedMilliseconds) {
        return this.getModel(moment$1(fromMilliseconds).subtract(10, 'year').valueOf(), selectedMilliseconds);
    };
...
var DlMonthModelProvider = /** @class */ (function () {
    ...
    DlMonthModelProvider.prototype.getModel = function (milliseconds, selectedMilliseconds) {
        var startDate = moment$2(milliseconds).startOf('year');
        var rowNumbers = [0, 1, 2];
        var columnNumbers = [0, 1, 2, 3];
        var previousYear = moment$2(startDate).subtract(1, 'year');
        var nextYear = moment$2(startDate).add(1, 'year');
        var activeValue = moment$2(milliseconds).startOf('month').valueOf();
        var selectedValue = selectedMilliseconds === null || selectedMilliseconds === undefined
            ? selectedMilliseconds
            : moment$2(selectedMilliseconds).startOf('month').valueOf();
        var result = {
            viewName: 'month',
        ...
        function rowOfMonths(rowNumber) {
            ...
            var cells = columnNumbers.map(function (columnNumber) {
                var monthMoment = moment$2(startDate).add((rowNumber * columnNumbers.length) + columnNumber, 'months');
                return {
    ...
    DlMonthModelProvider.prototype.goDown = function (fromMilliseconds, selectedMilliseconds) {
        return this.getModel(moment$2(fromMilliseconds).add(4, 'month').valueOf(), selectedMilliseconds);
    };
    DlMonthModelProvider.prototype.goUp = function (fromMilliseconds, selectedMilliseconds) {
        return this.getModel(moment$2(fromMilliseconds).subtract(4, 'month').valueOf(), selectedMilliseconds);
    };
    DlMonthModelProvider.prototype.goLeft = function (fromMilliseconds, selectedMilliseconds) {
        return this.getModel(moment$2(fromMilliseconds).subtract(1, 'month').valueOf(), selectedMilliseconds);
    };
    DlMonthModelProvider.prototype.goRight = function (fromMilliseconds, selectedMilliseconds) {
        return this.getModel(moment$2(fromMilliseconds).add(1, 'month').valueOf(), selectedMilliseconds);
    };
    DlMonthModelProvider.prototype.pageDown = function (fromMilliseconds, selectedMilliseconds) {
        return this.getModel(moment$2(fromMilliseconds).add(12, 'months').valueOf(), selectedMilliseconds);
    };
    DlMonthModelProvider.prototype.pageUp = function (fromMilliseconds, selectedMilliseconds) {
        return this.getModel(moment$2(fromMilliseconds).subtract(12, 'months').valueOf(), selectedMilliseconds);
    };
    DlMonthModelProvider.prototype.goEnd = function (fromMilliseconds, selectedMilliseconds) {
        return this.getModel(moment$2(fromMilliseconds).endOf('year').valueOf(), selectedMilliseconds);
    };
    DlMonthModelProvider.prototype.goHome = function (fromMilliseconds, selectedMilliseconds) {
        return this.getModel(moment$2(fromMilliseconds).startOf('year').valueOf(), selectedMilliseconds);
    };
...
var DlDayModelProvider = /** @class */ (function () {
    ...
    DlDayModelProvider.prototype.getModel = function (milliseconds, selectedMilliseconds) {
        var startOfMonth = moment$3(milliseconds).startOf('month');
        var endOfMonth = moment$3(milliseconds).endOf('month');
        var startOfView = moment$3(startOfMonth).subtract(Math.abs(startOfMonth.weekday()), 'days');
        var rowNumbers = [0, 1, 2, 3, 4, 5];
        var columnNumbers = [0, 1, 2, 3, 4, 5, 6];
        var previousMonth = moment$3(startOfMonth).subtract(1, 'month');
        var nextMonth = moment$3(startOfMonth).add(1, 'month');
        var activeValue = moment$3(milliseconds).startOf('day').valueOf();
        var selectedValue = selectedMilliseconds === null || selectedMilliseconds === undefined
            ? selectedMilliseconds
            : moment$3(selectedMilliseconds).startOf('day').valueOf();
        var result = {
            viewName: 'day',
            ...
            rowLabels: columnNumbers.map(function (column) { return moment$3().weekday(column).format('dd'); }),
        ...
        function rowOfDays(rowNumber) {
            ...
            var cells = columnNumbers.map(function (columnNumber) {
                var dayMoment = moment$3(startOfView).add((rowNumber * columnNumbers.length) + columnNumber, 'days');
                return {
    ...
    DlDayModelProvider.prototype.goDown = function (fromMilliseconds, selectedMilliseconds) {
        return this.getModel(moment$3(fromMilliseconds).add(7, 'days').valueOf(), selectedMilliseconds);
    };
    DlDayModelProvider.prototype.goUp = function (fromMilliseconds, selectedMilliseconds) {
        return this.getModel(moment$3(fromMilliseconds).subtract(7, 'days').valueOf(), selectedMilliseconds);
    };
    DlDayModelProvider.prototype.goLeft = function (fromMilliseconds, selectedMilliseconds) {
        return this.getModel(moment$3(fromMilliseconds).subtract(1, 'day').valueOf(), selectedMilliseconds);
    };
    DlDayModelProvider.prototype.goRight = function (fromMilliseconds, selectedMilliseconds) {
        return this.getModel(moment$3(fromMilliseconds).add(1, 'day').valueOf(), selectedMilliseconds);
    };
    ...
    DlDayModelProvider.prototype.goEnd = function (fromMilliseconds, selectedMilliseconds) {
        return this.getModel(moment$3(fromMilliseconds)
    ...
    DlDayModelProvider.prototype.goHome = function (fromMilliseconds, selectedMilliseconds) {
        return this.getModel(moment$3(fromMilliseconds).startOf('month').valueOf(), selectedMilliseconds);
    };
...
var DlHourModelProvider = /** @class */ (function () {
    ...
    DlHourModelProvider.prototype.getModel = function (milliseconds, selectedMilliseconds) {
        var startDate = moment$4(milliseconds).startOf('day');
        var rowNumbers = [0, 1, 2, 3, 4, 5];
        var columnNumbers = [0, 1, 2, 3];
        var previousDay = moment$4(startDate).subtract(1, 'day');
        var nextDay = moment$4(startDate).add(1, 'day');
        var activeValue = moment$4(milliseconds).startOf('hour').valueOf();
        var selectedValue = selectedMilliseconds === null || selectedMilliseconds === undefined
            ? selectedMilliseconds
            : moment$4(selectedMilliseconds).startOf('hour').valueOf();
        var result = {
            viewName: 'hour',
        ...
        function rowOfHours(rowNumber) {
            ...
            var cells = columnNumbers.map(function (columnNumber) {
                var hourMoment = moment$4(startDate).add((rowNumber * columnNumbers.length) + columnNumber, 'hours');
                return {
    ...
    DlHourModelProvider.prototype.goDown = function (fromMilliseconds, selectedMilliseconds) {
        return this.getModel(moment$4(fromMilliseconds).add(4, 'hour').valueOf(), selectedMilliseconds);
    };
    DlHourModelProvider.prototype.goUp = function (fromMilliseconds, selectedMilliseconds) {
        return this.getModel(moment$4(fromMilliseconds).subtract(4, 'hour').valueOf(), selectedMilliseconds);
    };
    DlHourModelProvider.prototype.goLeft = function (fromMilliseconds, selectedMilliseconds) {
        return this.getModel(moment$4(fromMilliseconds).subtract(1, 'hour').valueOf(), selectedMilliseconds);
    };
    DlHourModelProvider.prototype.goRight = function (fromMilliseconds, selectedMilliseconds) {
        return this.getModel(moment$4(fromMilliseconds).add(1, 'hour').valueOf(), selectedMilliseconds);
    };
    ...
    DlHourModelProvider.prototype.goHome = function (fromMilliseconds, selectedMilliseconds) {
        return this.getModel(moment$4(fromMilliseconds).startOf('day').valueOf(), selectedMilliseconds);
    };
...
var DlMinuteModelProvider = /** @class */ (function () {
    ...
    DlMinuteModelProvider.prototype.getModel = function (milliseconds, selectedMilliseconds) {
        var _this = this;
        var startDate = moment$5(milliseconds).startOf('hour');
        var currentMilliseconds = moment$5().valueOf();
        var minuteSteps = new Array(Math.ceil(60 / this.step)).fill(0).map(function (value, index) { return index * _this.step; });
        var minuteValues = minuteSteps.map(function (minutesToAdd) { return moment$5(startDate).add(minutesToAdd, 'minutes').valueOf(); });
        var activeValue = moment$5(minuteValues.filter(function (value) { return value <= milliseconds; }).pop()).valueOf();
        var nowValue = currentMilliseconds >= startDate.valueOf() && currentMilliseconds <= moment$5(startDate).endOf('hour').valueOf()
            ? moment$5(minuteValues.filter(function (value) { return value <= currentMilliseconds; }).pop()).valueOf()
            : null;
        var previousHour = moment$5(startDate).subtract(1, 'hour');
        var nextHour = moment$5(startDate).add(1, 'hour');
        var selectedValue = selectedMilliseconds === null || selectedMilliseconds === undefined
            ? selectedMilliseconds
            : moment$5(minuteValues.filter(function (value) { return value <= selectedMilliseconds; }).pop()).valueOf();
        ...
        function rowOfMinutes(stepMinutes) {
            var minuteMoment = moment$5(startDate).add(stepMinutes, 'minutes');
            return {
    ...
    DlMinuteModelProvider.prototype.goDown = function (fromMilliseconds, selectedMilliseconds) {
        return this.getModel(moment$5(fromMilliseconds).add(this.step * 4, 'minutes').valueOf(), selectedMilliseconds);
    };
    DlMinuteModelProvider.prototype.goUp = function (fromMilliseconds, selectedMilliseconds) {
        return this.getModel(moment$5(fromMilliseconds).subtract(this.step * 4, 'minutes').valueOf(), selectedMilliseconds);
    };
    DlMinuteModelProvider.prototype.goLeft = function (fromMilliseconds, selectedMilliseconds) {
        return this.getModel(moment$5(fromMilliseconds).subtract(this.step, 'minutes').valueOf(), selectedMilliseconds);
    };
    DlMinuteModelProvider.prototype.goRight = function (fromMilliseconds, selectedMilliseconds) {
        return this.getModel(moment$5(fromMilliseconds).add(this.step, 'minutes').valueOf(), selectedMilliseconds);
    };
    ...
    DlMinuteModelProvider.prototype.goHome = function (fromMilliseconds, selectedMilliseconds) {
        return this.getModel(moment$5(fromMilliseconds).startOf('hour').valueOf(), selectedMilliseconds);
    };
...
DlDateTimePickerModule.ctorParameters = function () { return []; };
var DlDateTimePickerNumberModule = /** @class */ (function () {
...
DlDateTimePickerNumberModule.ctorParameters = function () { return []; };
var DlDateTimePickerDateModule = /** @class */ (function () {
...
DlDateTimePickerDateModule.ctorParameters = function () { return []; };
var DlDateTimePickerMomentModule = /** @class */ (function () {
...
DlDateTimePickerMomentModule.ctorParameters = function () { return []; };

export { DlDateAdapter, DlDateAdapterMoment, DlDateAdapterNative, DlDateAdapterNumber, DlDateTimePickerChange, DlDateTimePickerComponent, DlDateTimePickerModule, DlDateTimePickerNumberModule, DlDateTimePickerDateModule, DlDateTimePickerMomentModule, DlDayModelProvider, DlHourModelProvider, DlMinuteModelProvider, DlMonthModelProvider, DlYearModelProvider };
